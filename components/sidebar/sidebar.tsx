...
export default function sidebar() {
  ...
  return (
    <aside className="fixed top-0 z-10 h-screen border-r border-gray-700 shadow-lg">
      <div className="flex flex-col items-center w-16 py-8 space-y-8 backdrop-blur-lg drop-shadow-lg">
        <a href="#">
